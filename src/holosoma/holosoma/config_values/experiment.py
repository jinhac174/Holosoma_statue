...
from holosoma.config_values.loco.statue.experiment import statue_28dof, statue_28dof_fast_sac
...
DEFAULTS = {
    ...
    "statue_28dof": statue_28dof,
    "statue_28dof_fast_sac": statue_28dof_fast_sac,
}
