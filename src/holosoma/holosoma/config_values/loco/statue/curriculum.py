"""Locomotion curriculum presets for the Statue robot."""

from holosoma.config_types.curriculum import CurriculumManagerCfg, CurriculumTermCfg

statue_28dof_curriculum = CurriculumManagerCfg(
    params={
...
statue_28dof_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
...
__all__ = ["statue_28dof_curriculum", "statue_28dof_curriculum_fast_sac"]
