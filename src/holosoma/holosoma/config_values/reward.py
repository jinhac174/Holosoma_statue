...
from holosoma.config_values.loco.statue.reward import statue_28dof_loco, statue_28dof_loco_fast_sac
...
DEFAULTS = {
    ...
    "statue_28dof_loco": statue_28dof_loco,
    "statue_28dof_loco_fast_sac": statue_28dof_loco_fast_sac,
