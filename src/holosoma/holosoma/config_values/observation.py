...
from holosoma.config_values.loco.statue.observation import statue_28dof_loco_single_wolinvel
...
DEFAULTS = {
    ...
    "statue_28dof_loco_single_wolinvel": statue_28dof_loco_single_wolinvel,
